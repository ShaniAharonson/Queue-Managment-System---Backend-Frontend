...
export class Appointment {
  ...
  constructor(id: number, appointmentDate: Date, appointmentStatus: AppointmentStatus, doctorType: DoctorType) {
    this.id = id;
  ...
  public static parseDateString(id: number, dateString: string, appointmentStatus: AppointmentStatus, doctorType: DoctorType): Appointment {
