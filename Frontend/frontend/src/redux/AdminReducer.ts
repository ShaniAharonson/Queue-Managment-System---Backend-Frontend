...
export function addPatientAction(newPatient: Patient): AdminAction {
...
export function getAllPatientsAction(patients: Patient[]): AdminAction {
...
export function getSinglePatientAction(patient: Patient): AdminAction {
...
export function updatePatientAction(updatedPatient: Patient): AdminAction {
